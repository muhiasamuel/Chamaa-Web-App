                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                ...
                                <h6 ><a class="text-white" href="{{ route('home')}}">Financial reports</a></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            ...
                            <div class="box bg-success text-center">
                                ...
                                <h1 class="font-light text-white"><i class="mdi mdi-chart-areaspline"></i> {{$chamaa->count()}}</h1>
                               
                                <h6 class="text-white"><a class="text-white" href="{{ route('admin.chamaa.index')}}">Manage Chamaas</a></h6></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                ...
                                <h6 class="text-white">Chamaa Admins</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i> {{$members->count()}}</h1>
                                <h6 class="text-white"><a class="text-white" href="{{ route('admin.member.index')}}">Registred Users/Members</a></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                ...
                                <h6 class="text-white">Chamaas Assets Management</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Manage Subscriptions</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                ...
                                <h6 class="text-white">Analitics</h6>
                            </div>
                        </div>
                    </div>
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                ...
                                <h6 class="text-white">Chamaa Expenses Management</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Site Analysis</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                ...
                                <h6 class="text-white">Manage Chamaa Funds</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <h5 class="m-b-0 m-t-5">{{$members->count()}}</h5>
                                            ...
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <h5 class="m-b-0 m-t-5">{{$chamaa->count()}}</h5>
                                                   <small class="font-light">Total Chamaas</small>
                                                </div>
                                            </div>
                                             <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <h5 class="m-b-0 m-t-5">20</h5>
                                                   <small class="font-light">Subscriptions</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Pending Subscriptions</small>
                                                </div>
                                            </div>
                                ...
                                <div class="todo-widget scrollable" style="height:450px;">
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40" src="{{asset('assets/images/users/1.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="{{asset('assets/images/users/4.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item todo-item" data-role="task">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="max-height: 130px;">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{asset('assets/images/users/3.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text active w-100">
                                        <h6 class="font-medium">Michael Jorden</h6>
                                        <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry. </span>
                                        <div class="comment-footer">
